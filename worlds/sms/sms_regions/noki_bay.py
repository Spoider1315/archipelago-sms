...
NOKI_BAY_ONE: SmsRegion = SmsRegion(SmsRegionName.NOKI_ONE,
...
NOKI_BAY_TWO: SmsRegion = SmsRegion(SmsRegionName.NOKI_TWO,
    requirements=[Requirements(location=f"{SmsRegionName.NOKI_ONE} - Uncork the Waterfall")],
    shines=[Shine("The Boss of Tricky Ruins", [Requirements(SPRAY_AND_HOVER)], in_game_bit=51),],
...
NOKI_BAY_THREE: SmsRegion = SmsRegion(SmsRegionName.NOKI_THREE,
    requirements=[Requirements(location=f"{SmsRegionName.NOKI_TWO} - The Boss of Tricky Ruins")],
    shines=[Shine("Red Coins in a Bottle", in_game_bit=52),], # Underwater Nozzle
    blue_coins=[],
    parent_region=SmsRegionName.NOKI_ENTRANCE
)

NOKI_BAY_FOUR: SmsRegion = SmsRegion(SmsRegionName.NOKI_FOUR,
    requirements=[Requirements(location=f"{SmsRegionName.NOKI_THREE} - Red Coins in a Bottle")],
    shines=[Shine("Eely-Mouth's Dentist", [Requirements(SPRAY_AND_HOVER)], in_game_bit=53),], # Underwater Nozzle
...
NOKI_BAY_FIVE: SmsRegion = SmsRegion(SmsRegionName.NOKI_FIVE,
    requirements=[Requirements(location=f"{SmsRegionName.NOKI_FOUR} - Eely-Mouth's Dentist")],
    shines=[Shine("Il Piantissimo's Surf Swim", in_game_bit=54),],
    blue_coins=[],
    parent_region=SmsRegionName.NOKI_ENTRANCE
)

NOKI_BAY_SIX: SmsRegion = SmsRegion(SmsRegionName.NOKI_SIX,
    requirements=[Requirements(location=f"{SmsRegionName.NOKI_FIVE} - Il Piantissimo's Surf Swim")],
    shines=[Shine("The Shell's Secret", [Requirements([[NozzleType.hover]])], in_game_bit=55),
        Shine("Red Coins on the Half Shell", [Requirements([[NozzleType.hover]])], in_game_bit=58),],
...
NOKI_BAY_SEVEN: SmsRegion = SmsRegion(SmsRegionName.NOKI_SEVEN,
    requirements=[Requirements(location=f"{SmsRegionName.NOKI_SIX} - The Shell's Secret")],
    shines=[Shine("Hold It, Shadow Mario!", [Requirements(SPRAY_AND_HOVER)], in_game_bit=56),],
    blue_coins=[],
    parent_region=SmsRegionName.NOKI_ENTRANCE
)

NOKI_BAY_EIGHT: SmsRegion = SmsRegion(SmsRegionName.NOKI_EIGHT,
    requirements=[Requirements(location=f"{SmsRegionName.NOKI_SEVEN} - Hold It, Shadow Mario!")],
    shines=[Shine("The Red Coin Fish", [Requirements([[NozzleType.hover]])], in_game_bit=57),], # Underwater Nozzle
    blue_coins=[],
    parent_region=SmsRegionName.NOKI_ENTRANCE
)