...
PIANTA_VILLAGE_ANY: SmsRegion = SmsRegion(SmsRegionName.PIANTA_ANY,
    shines=[Shine("Chain Chomplets Unchained", requirements=[Requirements(SPRAY_OR_HOVER)], hard=[Requirements(SPRAY_OR_HOVER_OR_TURBO)], in_game_bit=60),
        ...
        Shine("The Goopy Inferno", requirements=[Requirements(SPROCKET_OR_HOVER)], hard=[Requirements(SPROCKET_OR_HOVER_OR_TURBO)], tears=[Requirements(SPRAY_OR_HOVER_OR_TURBO)], in_game_bit=62),
        Shine("Chain Chomp's Bath", requirements=[Requirements([[NozzleType.spray]])], hard=[Requirements(manual_none=True)], in_game_bit=61),
...
PIANTA_VILLAGE_FIVE_BEYOND: SmsRegion = SmsRegion(SmsRegionName.PIANTA_FIVE_BEYOND,
    ...
    shines=[Shine("Secret of the Village Underside", requirements=[Requirements([[NozzleType.yoshi]])], advanced=[Requirements(HOVER_OR_YOSHI)], in_game_bit=64),
        Shine("Piantas in Need", requirements=[Requirements(SPRAY_OR_HOVER)], advanced=[Requirements(SPRAY_OR_HOVER_OR_TURBO)], in_game_bit=63),
        Shine("Shadow Mario Runs Wild", requirements=[Requirements([[NozzleType.spray]], location=f"{SmsRegionName.PIANTA_FIVE_BEYOND} - Piantas in Need")], advanced=[Requirements(SPRAY_OR_HOVER, location=f"{SmsRegionName.PIANTA_FIVE_BEYOND} - Piantas in Need")], in_game_bit=66),
        Shine("Fluff Festival Coin Hunt", requirements=[Requirements(ROCKET_OR_HOVER, location=f"{SmsRegionName.PIANTA_FIVE_BEYOND} - Shadow Mario Runs Wild")], advanced=[Requirements(ROCKET_OR_HOVER_OR_TURBO, location=f"{SmsRegionName.PIANTA_FIVE_BEYOND} - Shadow Mario Runs Wild")], in_game_bit=67),
        Shine("Red Coin Chucksters", requirements=[Requirements(YOSHI_AND_HOVER)], advanced=[Requirements([[NozzleType.hover]])], tears=[Requirements(HOVER_OR_YOSHI)], in_game_bit=68)
    ], parent_region=SmsRegionName.PIANTA_ENTRANCE)
...
PIANTA_VILLAGE_EIGHT: SmsRegion = SmsRegion(SmsRegionName.PIANTA_EIGHT,
    ...
    shines=[Shine("Soak the Sun", requirements=[Requirements(SPRAY_AND_ROCKET_OR_SPRAY_AND_HOVER)], hard=[Requirements(SPRAY_AND_OTHER_FLUDD)], in_game_bit=69)],
