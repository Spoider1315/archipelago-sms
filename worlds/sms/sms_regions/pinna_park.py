...
PINNA_PARK_ONE: SmsRegion = SmsRegion(SmsRegionName.PINNA_ONE,
    ...
    blue_coins=[BlueCoin("Tree Sand Shine", [Requirements(ANY_SPLASHER)], in_game_bit=348),
        ...
        BlueCoin("Beach Butterfly A", [Requirements([[NozzleType.yoshi]])], in_game_bit=343),
...
PINNA_PARK_TWO: SmsRegion = SmsRegion(SmsRegionName.PINNA_TWO,
    ...
    shines=[Shine("The Beach Cannon's Secret", [Requirements(SPRAY_OR_HOVER)], in_game_bit=31),
        Shine("Red Coins in the Cannon", [Requirements([[NozzleType.hover]])], in_game_bit=38),
...
PINNA_PARK_THREE: SmsRegion = SmsRegion(SmsRegionName.PINNA_THREE,
    requirements=[Requirements(location=f"{SmsRegionName.PINNA_TWO} - The Beach Cannon's Secret")],
    shines=[Shine("Red Coins of the Pirate Ships", [Requirements([[NozzleType.hover]])], in_game_bit=32),],
    blue_coins=[],
    parent_region=SmsRegionName.PINNA_ENTRANCE
)

PINNA_PARK_FOUR: SmsRegion = SmsRegion(SmsRegionName.PINNA_FOUR,
    requirements=[Requirements(location=f"{SmsRegionName.PINNA_THREE} - Red Coins of the Pirate Ships")],
    shines=[Shine("The Wilted Sunflowers", [Requirements(ANY_SPLASHER)], in_game_bit=33)],
    blue_coins=[],
    parent_region=SmsRegionName.PINNA_ENTRANCE
)

PINNA_PARK_FIVE: SmsRegion = SmsRegion(SmsRegionName.PINNA_FIVE,
    requirements=[Requirements(location=f"{SmsRegionName.PINNA_FOUR} - The Wilted Sunflowers")],
...
PINNA_PARK_SIX: SmsRegion = SmsRegion(SmsRegionName.PINNA_SIX,
    requirements=[Requirements(location=f"{SmsRegionName.PINNA_FIVE} - The Runaway Ferris Wheel")],
    shines=[Shine("The Yoshi-Go-Round's Secret", [Requirements([[NozzleType.yoshi]])], in_game_bit=35),
        Shine("Red Coins in the Yoshi-Go-Round", [Requirements(YOSHI_AND_HOVER)], in_game_bit=39),],
    blue_coins=[BlueCoin("Park Butterfly", [Requirements([[NozzleType.yoshi]])], in_game_bit=335)],
    parent_region=SmsRegionName.PINNA_ENTRANCE
)

PINNA_PARK_SEVEN: SmsRegion = SmsRegion(SmsRegionName.PINNA_SEVEN,
    requirements=[Requirements(location=f"{SmsRegionName.PINNA_SIX} - The Yoshi-Go-Round's Secret")],
    shines=[Shine("Shadow Mario in the Park", in_game_bit=36),],
    blue_coins=[],
    parent_region=SmsRegionName.PINNA_ENTRANCE
)

PINNA_PARK_EIGHT: SmsRegion = SmsRegion(SmsRegionName.PINNA_EIGHT,
    requirements=[Requirements(location=f"{SmsRegionName.PINNA_SEVEN} - Shadow Mario in the Park")],
    shines=[Shine("Roller Coaster Balloons", [Requirements([[NozzleType.spray]])], in_game_bit=37)],
    blue_coins=[],
    parent_region=SmsRegionName.PINNA_ENTRANCE
)